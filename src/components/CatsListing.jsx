...
const CatsListing = () => {
  ...
  const limit = 4; // Number of cards per page
  ...
  useEffect(() => {
    const fetchCats = async () => {
      ...
      try {
        ...
        setCats((prevCats) => [...prevCats, ...res.data.data.data]); // Append new cats to the existing list
        setLoading(false);
      } catch (error) {
  ...
  const handleInfiniteScroll = () => {
    ...
    // Check if user has scrolled to the end of the container
          ...
          <div key={index} className={styles.catCard}>
            ...
            <div className={styles.wrapper}>
              ...
              <div className={styles.temperamentSection}>
                <p className={styles.temperamentLabel}>
                  Temperament
                </p>
                  {cat.temperament
                    .split(", ")
